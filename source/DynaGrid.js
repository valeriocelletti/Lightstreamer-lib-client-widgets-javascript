...
define(["Inheritance","./AbstractGrid","./Cell","./VisibleParent","./InvisibleParent","./DynaElement",
  ...
  DynaGrid.prototype = {
     ...
     * logical page can be shown by calling the {@link #goToPage} method.
...
//////////////////////////////////TEMPLATE SETUP    
    ...
    prepareAutoScroll: function() {
      // gestione autoscroll: prendo il node da scrollare se si tratta
...
//>>excludeEnd("debugExclude"); 
    ...
    calculateSortedPosition: function(toUpdate,oldSortVal,newSortVal) {
      ...
      //eseguo una ricerca binaria a caccia di una chiave uguale 
      //o del caso peggiore in cui up supera down 
      while (up < down) {
...
//Listener Interface ---->
  ...
  DynaGridListener.prototype = {
       ...
       *   
       * @param {DOMElement} domNode The DOM pointer to the HTML row involved.

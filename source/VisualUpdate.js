...
*/
define(["LoggerManager","Inheritance","Setter","IllegalArgumentException"],
    function(LoggerManager,Inheritance,Setter,IllegalArgumentException) {
  ...
  VisualUpdate.prototype = {
     ...
     * the value in the cell is unchanged, then a call to {@link #setCellValue} can
     * be performed using the value from this getter.
     * <BR>In order to inquiry the values for the row cells on the underlying
     * model, the {@link #getChangedFieldValue} method is available.
     * 
     ...
     * {@link #setColdToHotTime} and/or {@link #setHotToColdTime},
     ...
     * specified in {@link #setColdToHotTime} and/or {@link #setHotToColdTime},
     ...
     * <BR>If a row stylesheet is set through the {@link #setStyle} method,
     ...
     * specified neither with this method nor with {@link #setStyle}, the
     ...
     * a fading behavior, the {@link #setAttribute} method should be used instead,
     ...
     * made through {@link #setAttribute}.
     * <BR>If a specific stylesheet is assigned to the field through the
     * {@link #setStyle} or {@link #setCellStyle} method,
     ...
     * <br/>By default  the settings possibly made by {@link #setAttribute}
     * are used.</p>
     * 
     * @throws {IllegalArgumentException} if no cells were associated with
     * the specified field.
     ...
     * made through {@link #setStyle}.
     * <br/>By default the stylesheet possibly set through {@link #setStyle}
     * is used.</p>
     * 
     * @throws {IllegalArgumentException} if no cells were associated with
     * the specified field.

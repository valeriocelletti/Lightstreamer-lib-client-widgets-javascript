...
define(["Inheritance","Matrix","LoggerManager","Setter","EventDispatcher",
   ...
   * Subscription, the {@link #parseHtml} method has to be called to prepare the view.
  ...
  AbstractWidget.prototype = {
      ...
      */
       ...
       * 
       * <p class="lifecycle"><b>Lifecycle:</b> once the {@link #parseHtml} method has been called, 
       ...
       * <p class="lifecycle"><b>Lifecycle:</b> This method can be called at any time.</p>
       * 
       * @param {boolean} onFirstSubscribe If true a {@link #clean} call will be 
       ...
       * 
       * @param {boolean} onLastUnsubscribe If true a {@link #clean} call will be 
       * automatically performed if in the list of Subscriptions this instance is 

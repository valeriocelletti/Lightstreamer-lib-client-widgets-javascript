...
*/
define(["LoggerManager","Setter","Inheritance","./Cell","IllegalArgumentException"],
    function(LoggerManager,Setter,Inheritance,Cell,IllegalArgumentException) {
  ...
  ChartLine.prototype = {
      ...
      setYLabels: function(labelsNum, labelsClass, labelsFormatter) {
        ...
        if (this.yUnit != null && this.parent && this.parent.painter) {
          //l'asse Y è già configurato, disegno le labels

...
define(["Inheritance","./CellMatrix","Executor","../Cell","Helpers",
  ...
  AbstractGrid.prototype = {
       ...
       * during the mapping of the grid to the HTML made by {@link #parseHtml}.
       *
       ...
       * However, if the list is changed after the execution of the {@link #parseHtml}
       * method then it will not be used until a new call to such method is performed.
       * </p>
       *
       * @param {Array} nodeTypes an array of Strings representing the names of the node 
       ...
       * in case of a call to {@link #parseHtml}.
       *
       ...
       * <BR>Note that if the sort is enabled on the Grid through {@link #setSort}
       ...
       * {@link #parseHtml} execution. The result of this method is supposed to be 
       ...
       * associated to this grid during the {@link #parseHtml} execution.

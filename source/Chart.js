...
*/
define(["./AbstractWidget","./Cell","LoggerManager","Inheritance","Helpers","Environment",
        "./ChartLine","./ChartPainter",
        "IllegalStateException","IllegalArgumentException"],
    function(AbstractWidget,Cell,LoggerManager,Inheritance,Helpers,Environment,
        ChartLine,ChartPainter,
        IllegalStateException,IllegalArgumentException) {
   ...
   * {@link #setXAxis} and {@link #addYAxis}, 
  ...
  Chart.prototype = {
       ...
       * {@link #positionXAxis} method, otherwise a 
       ...
       * {@link #configureArea} setting. Moreover, as the first and last labels
      ...
      setXLabels: function(labelsNum, labelsClass, labelsFormatter) {
        ...
        if (this.xUnit != null) {
          //l'asse X è già configurato, disegno le labels

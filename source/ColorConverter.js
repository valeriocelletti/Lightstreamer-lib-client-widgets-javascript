define(["Environment","LoggerManager","BrowserDetection","IFrameHandler"], 
    function(Environment,LoggerManager,BrowserDetection,IFrameHandler){
  ...
  function translateColorNameByDIV(colorName) {
    ...
    if (val[0] == 255 && val[1] == 255 && val[2] == 255) {
      if (colorName.toUpperCase() != "WHITE" ) {
        //ho fallito. provo appendendo prima
        //il figlio alla pagina
  ...
  function nameToRGBArray(colorName) {
    var res = "";
    /*su IE si nota il doppio cambio di sfondo, su FX no
     *su FX usare l' engine per cambiare lo sfondo non funziona, su IE si
     *per opera creiamo un div assegnamo il colore e facvciamo una getStyle
     */
